...
export default async function Workflows(){
 ...
 const [health,projects]=await Promise.all([loadServiceHealth(),prisma.project.findMany({where:{companyId:BOOSTA_COMPANY_ID,authorisedStatus:true},orderBy:{createdAt:'desc'},select:{id:true,name:true,productionUrl:true}})]);
